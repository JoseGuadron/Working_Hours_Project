     ...
     <div class="container col-xs-12 col-sm-8 col-md-6 col-lg-4" id= "LoginArea" >
       ...
       <br>
        ...
        <div class="form-group">
           <label for="Username"  style="color: #424242">Administrator name</label>
           <input name="username" class="form-control" aria-describedby="UserHelp" placeholder="Enter Admin name">
        ...
        <div class="form-group">
             ...
             <input type="password" name="password" class="form-control" placeholder="Enter Password">
                 <a rel="facebox" href="index.php"><small style="color: #ffab00">Login as User</small></a>
